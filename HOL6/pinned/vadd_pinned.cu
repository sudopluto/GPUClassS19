...
int main( int argc, char* argv[] ) { 
	...
	Data data_cpu;
    // HERE
	cudaMallocHost((void**)&data_cpu.a, (sizeof(double) * vector_size)); 
	cudaMallocHost((void**)&data_cpu.b, (sizeof(double) * vector_size)); 
	cudaMallocHost((void**)&data_cpu.c, (sizeof(double) * vector_size)); 
	Data data_gpu_on_cpu;
	cudaMallocHost((void**)&data_gpu_on_cpu.c, (sizeof(double) * vector_size)); 
